        ...
        <Row>
          <Col xs="12" sm="12">
            <Card>
                  ...
                  <Col md="3">
                    <InputGroup className="input-prepend">
                      ...
                      <Input type="select" name="ccmonth" id="ccmonth">
                        <option value="">Select</option><option value="OPEN">OPEN</option><option value="PENDING">PENDING</option><option value="CLOSED">CLOSED</option>
                      </Input>
                    </InputGroup>
                  </Col>
                  <Col md="3">
              ...
              <CardFooter><center>
                <Button type="submit" size="sm" color="primary"><i className="fa fa-search"></i> Search</Button>&nbsp;&nbsp;
