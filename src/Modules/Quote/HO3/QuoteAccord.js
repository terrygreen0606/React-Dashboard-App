...
class QuoteAccord extends Component {
  ...
  updateUWquestion = (questionArray) => {
    this.setState({uwQuestion: questionArray});
  }
  ...
  render() {
    ...
    return (
      <div id="accordion" className="p-0">
          ...
          <Collapse isOpen={this.state.accordion[6]} data-parent="#accordion" id="collapseSix">
            <CardBody>
              <Row>
                ...
                <Col sm="9"><WindMitigation quoteSavedData={this.props.quoteSavedData} mainState={this.props.mainState}/></Col>
              </Row>
            </CardBody>
          </Collapse>
        </Card>
        ...
        <Card className="mb-0 borderNN">
          <CardHeader id="headingNine" className="p-1">
          ...
          <Collapse isOpen={this.state.accordion[8]} data-parent="#accordion" id="collapseNine">
            <CardBody>
              <UWQuestions updateUWquestion={this.updateUWquestion} quoteSavedData={this.props.quoteSavedData} mainState={this.props.mainState} />
              <Input type="hidden" name="uwQuestions" value={this.state.uwQuestion.join('|')} />
            </CardBody>
          </Collapse>
        </Card>
      </div>
