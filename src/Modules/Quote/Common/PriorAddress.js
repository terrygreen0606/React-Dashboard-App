...
const PriorAddress = props => {
  ...
  const selAllSavedData = () => {
    var mailingData = props.quoteSavedData.applicantData.getPriorAddr;
    if(mailingData != null){
  ...
  const getDataFromZip = (zipCodeVal) => {
    props.dispatch(QuoteEntryService.getZipDetails(props.mainState.product, zipCodeVal, 'PRIOR'))
      .then((res) => {
        if (res.status == 'N') {
      ...
      <Row className="p-0 m-0">
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            ...
            <Input type="text" bsSize="sm" name="data[TbPersonaddressPrior][s_HouseNo]" value={houseNo} onChange={(e)=>setHouseNo(e.target.value)} disabled={props.mainState.isBind}/>
          </FormGroup>
        </Col>
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            <Label id='s_HouseDirection1' className="mb-0">Direction</Label>
            <Input type="select" bsSize="sm" name="data[TbPersonaddressPrior][s_HouseDirection1]" value={direction1} onChange={(e)=>setDirection1(e.target.value)} disabled={props.mainState.isBind}>
        ...
        <Col md="2" className="p-1">
          <FormGroup className="m-0">
            ...
            <Input type="text" bsSize="sm" name="data[TbPersonaddressPrior][s_StreetName]" value={streetName} onChange={(e)=>setStreetName(e.target.value.toUpperCase())} disabled={props.mainState.isBind}/>
          </FormGroup>
        </Col>
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            <Label id='s_HouseType' className="mb-0">Type</Label>
            <Input type="select" bsSize="sm" name="data[TbPersonaddressPrior][s_HouseType]" value={houseType} onChange={(e)=>setHousetype(e.target.value)} disabled={props.mainState.isBind}>
              <option key="" value="">Select</option>
        ...
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            ...
            <Input type="text" bsSize="sm" name="data[TbPersonaddressPrior][s_PostalCode]" placeholder="Enter Zip Code" value={zipCode} onChange={(e)=>setZipCode(e.target.value)} onBlur={(e) => getDataFromZip(e.target.value)} disabled={props.mainState.isBind}/>
            <Input type="hidden" name="data[TbPersonaddressPrior][n_Zipcodes_PK]" id="n_Zipcodes_PK" value={zipCodePK} disabled={props.mainState.isBind} />
          </FormGroup>
        </Col>
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            <Label id='StreetName' className="mb-0">City</Label>
            <Input type="text" bsSize="sm" name="n_CityId_FKName2" placeholder="Enter City" value={city} readOnly disabled={props.mainState.isBind}/>
            <Input type="hidden" name="data[TbPersonaddressPrior][n_CityId_FK]" id="n_CityId_FK" value={cityFK} disabled={props.mainState.isBind} />
          </FormGroup>
        </Col>
        <Col md="2" className="p-1">
          <FormGroup className="m-0" >
            <Label id='n_StateId_FKName' className="mb-0">State</Label>
            <Input type="text" bsSize="sm" name="n_StateId_FKName2" placeholder="Enter State" value={state} readOnly/>
            <Input type="hidden" name="data[TbPersonaddressPrior][n_StateId_FK]" id="n_StateId_FK" value={stateFK} disabled={props.mainState.isBind} />
          </FormGroup>
        </Col>
        <Col md="1" className="p-1">
          <FormGroup className="m-0">
            <Label id='s_HouseDirection2' className="mb-0">Direction</Label>
            <Input type="select" bsSize="sm" name="data[TbPersonaddressPrior][s_HouseDirection2]" value={direction2} onChange={(e)=>setdirection2(e.target.value)} disabled={props.mainState.isBind}>
              <option key="" value="">Select</option>
              {props.baseData != null?props.baseData.HOMEADDRESSDIRECTION.map((comp, i) => {
                return (
                  <option key={i} value={comp.s_AppCodeName}>{comp.s_AppCodeNameForDisplay}</option>
        ...
        <Col md="2" className="p-1">
          <FormGroup className="m-0">
            ...
            <Input type="text" bsSize="sm" name="n_CountyId_FKName2" placeholder="County" value={county} readOnly disabled={props.mainState.isBind}/>
            <Input type="hidden" name="data[TbPersonaddressPrior][n_CountyId_FK]" id="n_CountyId_FK" value={countyFK} disabled={props.mainState.isBind} />
            <Input type="hidden" name="data[TbPersonaddressPrior][n_CountryId_FK]" id="n_CountryId_FK" value={countryFK} disabled={props.mainState.isBind} />
          </FormGroup>
        </Col>
      </Row>
...
export default connect(mapStateToProps)(PriorAddress);