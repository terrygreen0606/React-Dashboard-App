...
const PropertyDetails = props => {
  ...
  const [windPool, setWindPool] = useState('');
  ...
  const setAllSavedData = () => {
    ...
    setNoOfResidents(propertyData.n_NoOfFamilies);
    ...
    setSurfaceRoughness(propertyData.s_SurfaceRoughness);
    setWindPool(propertyData.s_WindPoolCode);
    ...
    <React.Fragment>
      <Row className="p-0 m-0">
        ...
        <Col md="1" className="p-1">
          <InputGroup className="input-prepend">
            <Label className="mb-0" id='n_NoOfFamilies'>No. of Units</Label>
          </InputGroup>
          <Input type="text" bsSize="sm" name="data[TbPoriskadditionalinfo][n_NoOfFamilies]" value={noOfResidents} onChange={(e) => setNoOfResidents(e.target.value)} disabled={props.mainState.isBind} />
        </Col>
        <Col md="1" className="p-1">
        ...
        <Col md="1" className="p-1">
          ...
          <Input type="text" bsSize="sm" name="data[yearbuilt]" value={yearBuild} onChange={(e) => setYearBuild(e.target.value)} onInput={(e) => onInputChange(e)} disabled={props.mainState.isBind} />
        </Col>
        <Col md="2" className="p-1">
      ...
      <Row className="p-0 m-0">
        ...
        <Col md="2" className='p-1'>
          <Label className="mb-0">Surface Roughness</Label>
          <Input type="text" bsSize="sm" name="data[TbPoriskadditionalinfo][s_SurfaceRoughness]" value={surfaceRoughness} onChange={(e) => setSurfaceRoughness(e.target.value)} disabled={props.mainState.isBind} />
        </Col>
        <Col md="2" className='p-1'>
          <Label className="mb-0">Wind Pool Eligibility</Label>
          <Input type="select" bsSize="sm" name="data[WINDPOOLELIGIBILITY]" value={windPool} onChange={(e) => setWindPool(e.target.value)} disabled={props.mainState.isBind}>
            <option key="" value="">Select</option>
            {props.baseData != null ? props.baseData.WINDPOOLELIGIBILITY.map((comp, i) => {
              return (
                <option key={i} value={comp.s_AppCodeName}>{comp.s_AppCodeNameForDisplay}</option>
              );
            }) : null}
