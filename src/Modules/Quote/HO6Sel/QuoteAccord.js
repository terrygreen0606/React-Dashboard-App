              ...
              <Row className='mt-2'>
                ...
                <Col md="1" >
                  <FormGroup check inline className="text-center">
                    ...
                    <AppSwitch size="sm" className={'mt-2'} variant={'pill'} color={'success'} name="listalllosses" checked={this.state.isListAllLosses} onChange={this.showListAllLosses} value={this.state.isListAllLosses ? 'Yes' : ''} />&nbsp;&nbsp;
