      ...
      {props.baseData != null ?
        props.baseData.all_endorsement_Coverage.map((cvg, i) => {
          ...
          if (cvg.s_LimitCodeType == 'NOEDIT') {
            ...
            fieldsPart = (
              <Col md="5"><Input type="true" bsSize="sm" name={"txtCvgLimitAmt_" + cvg.n_PCCoverageID_PK} id={"txtCvgLimitAmt_" + cvg.n_PCCoverageID_PK} disabled={props.mainState.isBind} /></Col>
            );
