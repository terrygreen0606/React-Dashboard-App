...
const EndorsmentCvg = props => {
  const [hdnEndorsCvg, sethdnEndorsCvg] = useState([12]);
        ...
        props.baseData.all_endorsement_Coverage.map((cvg, i) => {
          ...
          if (cvg.s_LimitCodeType == 'NOEDIT') {
            ...
            fieldsPart = (
              <React.Fragment>
                <Col md="3">
                  <Input type="text" bsSize="sm" name={"txtCvgLimitAmt_" + cvg.n_PCCoverageID_PK} id={"txtCvgLimitAmt_" + cvg.n_PCCoverageID_PK} />
                </Col>
