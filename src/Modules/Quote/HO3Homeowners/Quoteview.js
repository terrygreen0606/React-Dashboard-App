...
class Quoteview extends Component {
  ...
  render() {
    return (
      <LoadingOverlay>
        <Helmet>
          <title>Avatar Insurance - Quote HO3 Homeowners</title>
        </Helmet>
        ...
        <Form method="post" onSubmit={this.saveQuoteEntryData} onKeyDown={(e) => { if (e.keyCode === 13) { e.preventDefault(); return false; } }} className="animated fadeIn mt-1">
          <Row>
            <Col xs="12">
              <strong><span className="badge badge-success"><h5><i className="fa fa-home"></i>&nbsp;&nbsp;HO3 Homeowners</h5></span></strong>
