      ...
      <Row className="p-0 m-0">
        ...
        <Col md="1" className='p-1'>          
            ...
            <DatePicker 
              ...
              className="form-control form-control-sm" id="d_BirthDate" name="data[TbPersoninfo][d_BirthDate]" placeholderText="MM/DD/YYYY" selected={dob} onChange={(date) => setDob(date)}
               disabled={props.mainState.isBind} />
        </Col>
        <Col md="2" className='p-1'>
            <Label id='s_OccupationDes' className="mb-0">Occupation</Label>
            <Input type="text" bsSize="sm" name="data[TbPersoninfo][s_OccupationDesc]" id="s_OccupationDes" placeholder="Occupation" value={occupation} onChange={(e)=>setOccupation(e.target.value.toUpperCase())}/>
        </Col>
      </Row>
      <Row className="p-0 m-0">
        <Col md="1" className='p-1'>
        ...
        <Col md="1" className='p-1'>
            ...
            <Input type="text" bsSize="sm" name="data[TbPersonaddress][s_PostalCode]" id="s_PostalCode" placeholder="Enter Zip Code" value={zipCode} onChange={(e) => setZipCode(e.target.value)} onBlur={(e) => getDataFromZip(e.target.value)} valid={isZipValid} onInput={(e) => onInputChange(e)} disabled={props.mainState.isBind} />
        ...
        <Col md="2" className='p-1'>          
            ...
            <Input type="hidden" name="Propertyzone" id="Propertyzone" value="" disabled={props.mainState.isBind} />
        </Col>
        <Col md="1" className='p-1'>
        ...
        <Col md="2" className='p-1'>
            ...
            <Input type="email" bsSize="sm" id="s_EmailAddress" name="data[TbEmailinfo][s_EmailAddress]" placeholder="Email Address" value={email} onChange={(e)=>setEmail(e.target.value)} onBlur={(e) => validateFields(e)}/>
        </Col>
        <Col md="1" className='p-1'>
            <InputGroup className="input-prepend">
