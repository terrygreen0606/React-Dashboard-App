...
import { LocalForm, actions, Errors, Control} from 'react-redux-form';
import { required } from '../../../../utilities/regex';
import Select from "react-select";
import Message from '../../../../utilities/message';
import { getCountry } from '../../../../services/territory';

export default ({ history, match, data={}, type=null, loader, categories,editSecurity, dispatch, countries }) => {
...
/*******Reset Form****** */
    const resetForm = () => {
        ['security.Currency_Symbol', 'security.Bond_Category_ID', 'security.Cusip', 'security.Description', 'security.Country_ID'].map(key =>
...
/************* Handle submit  *******/
    ...
    return (
        ...
        >
            ...
            <FormGroup row className="col-md-12">
            <Col className="col-md-4">
                    <Label htmlFor="text-input">Currency Name*:</Label>
                    <Control
                        model=".Cusip"
                        component={props => <Input {...props} type="text" id="text-input" name="text-input" placeholder="Currency Name" />}
                        validators={{ required }}
                    />
                    <Errors
                        model=".Cusip"
