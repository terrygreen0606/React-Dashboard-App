        ...
        :
          ...
          <>
            <BootstrapTable isKey={false} data={accView_arr} version="4" striped hover pagination search tabIndexCell >
              <TableHeaderColumn width="15%" dataField="d_AccountingDate" dataSort >ACC DT.</TableHeaderColumn>
              <TableHeaderColumn dataField="OriginalTranType">TRAN TYPE</TableHeaderColumn>
              <TableHeaderColumn isKey dataField="s_TransRefNo" dataFormat={this.accViewLink} >TRAN REF</TableHeaderColumn>
              ...
              <TableHeaderColumn dataField="d_CreatedDate" >SYSTEM DT.</TableHeaderColumn>
