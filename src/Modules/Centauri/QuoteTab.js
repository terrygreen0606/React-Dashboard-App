  ...
  render() {
    return (
      <div className="animated fadeIn">
          ...
          <CardBody>
            <Row>
              <Col md="3" className=''>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='FirstName'>First Name</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className=''>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='MiddleName'>Middle Name</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className=''>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='MiddleName'>Last Name</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className=''>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='MiddleName'>Name(s) on Dec</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className='mt-2'>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='BinderDate'>DOB</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className='mt-2'>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='BinderDate'>Phone No.</InputGroupText>
                  </InputGroupAddon>
              ...
              <Col md="3" className='mt-2'>
                <InputGroup className="input-prepend">
                  <InputGroupAddon addonType="prepend">
                    <InputGroupText id='BinderDate'>Email Address</InputGroupText>
                  </InputGroupAddon>
        ...
        <Card>
          <CardHeader>
            <strong>Prior or Current Address</strong>
            <small></small>
          </CardHeader>
          <CardBody>
            <Row>
        ...
        <Card>
          <CardHeader>
            <strong>Basic Coverage's</strong>
            <small></small>
          </CardHeader>
          <CardBody>
            <Row>
        ...
        <Card>
          <CardHeader>
            <strong>Underwriting Questions</strong>
            <small></small>
          </CardHeader>
          <CardBody>
            <Row>
