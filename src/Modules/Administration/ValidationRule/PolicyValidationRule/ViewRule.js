...
class PolicyValidationRuleListing extends Component {
    constructor(props) {
        super(props);
    ...
    renderMyData() {
        this.props.dispatch(this.apiService.fetchPolicyValidationRuleListing())
            .then((resp) => {
                ...
                for (let i = 0; i < getData.length; i++) {
                    filterData.push({
                        ...
                        ruleDesc: getData[i].s_Description,
                        productName: getData[i].product.s_ProductName,
                        edit: getData[i].n_PrValidationRuleMaster_PK
                    });
                }
                ...
                this.error('Error in fetching validation rules.');
            });
    }
    ...
    handleClick = id => e => {
        e.preventDefault();
        window.location = '/administration/policy/edit-validation-rule/' + id;
    };
            ...
            <div className="animated">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <a href="/administration/policy/create-validation-rule" className="btn btn-success">Create Rule</a>
                    </CardHeader>
                    <CardBody>
...
const mapStateToProps = state => ({
    listData: state.Administration.fetchPolicyValidationRuleListing,
});


export default connect(mapStateToProps)(PolicyValidationRuleListing);
